...
class WEBCRAWLER():
    ...
    def __extract_cabinet_table(self, payload):
        response = requests.post('https://www.saopaulo.sp.leg.br/transparencia/salarios-abertos/salarios-abertos/remuneracao-dos-servidores-e-afastados/', data=payload).text
        return response
